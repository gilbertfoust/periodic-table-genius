...
/**
 * Curated database of well-known chemical compounds.
 * Key format: atomic numbers sorted ascending, "Z:count" joined by commas.
 * Example: H₂O = "1:2,8:1" (H=1, O=8)
 */
export const KNOWN_COMPOUNDS: Record<string, KnownCompound> = {
  ...
  '1:2,8:1': {
    ...
    related: [
      { key: '1:2,8:2', formula: 'H₂O₂', name: 'Hydrogen Peroxide', note: 'Add one more oxygen and you get hydrogen peroxide — a powerful oxidizer. That single extra O makes it unstable and reactive!' },
    ],
  },
  '1:2,8:2': {
    key: '1:2,8:2',
    ...
    related: [
      { key: '1:2,8:1', formula: 'H₂O', name: 'Water', note: 'Remove one oxygen and you get plain water — stable, safe, and essential for life.' },
    ],
  },
  ...
  '11:1,17:1': {
    ...
    formula: 'NaCl',
    name: 'Table Salt',
    aliases: ['Sodium Chloride', 'Halite'],
    ...
    related: [
      { key: '11:2,8:1', formula: 'Na₂O', name: 'Sodium Oxide', note: 'Replace chlorine with oxygen and you get sodium oxide — a reactive white solid.' },
    ],
  },
  '19:1,17:1': {
    key: '19:1,17:1',
    ...
    related: [
      { key: '11:1,17:1', formula: 'NaCl', name: 'Table Salt', note: 'Swap potassium for sodium and you get ordinary table salt.' },
    ],
  },
  ...
  '6:1,8:2': {
    ...
    related: [
      { key: '6:1,8:1', formula: 'CO', name: 'Carbon Monoxide', note: 'Remove one oxygen and you get carbon monoxide — a colorless, odorless, deadly poison. That missing O changes everything.' },
    ],
  },
  '6:1,8:1': {
    key: '6:1,8:1',
    ...
    related: [
      { key: '6:1,8:2', formula: 'CO₂', name: 'Carbon Dioxide', note: 'Add one more oxygen and you get carbon dioxide — harmless at normal levels and essential for plants.' },
    ],
  },
  '1:4,6:1': {
    key: '1:4,6:1',
    ...
    related: [
      { key: '1:6,6:2', formula: 'C₂H₆', name: 'Ethane', note: 'Double the carbons and hydrogens and you start building longer hydrocarbon chains.' },
    ],
  },
  '1:6,6:2': {
    key: '1:6,6:2',
    ...
    related: [
      { key: '1:4,6:1', formula: 'CH₄', name: 'Methane', note: 'Cut it in half and you get methane — the simplest hydrocarbon.' },
    ],
  },
  ...
  '1:1,17:1': {
    ...
    related: [
      { key: '11:1,17:1', formula: 'NaCl', name: 'Table Salt', note: 'Add sodium instead of hydrogen and you get table salt — from acid to seasoning!' },
    ],
  },
  '1:1,9:1': {
    key: '1:1,9:1',
    ...
    related: [
      { key: '1:1,17:1', formula: 'HCl', name: 'Hydrochloric Acid', note: 'Swap fluorine for chlorine and you get hydrochloric acid — a stronger acid but less corrosive to glass.' },
    ],
  },
  '1:2,16:1,8:4': {
    key: '1:2,16:1,8:4',
  ...
  '7:1,8:1': {
    ...
    related: [
      { key: '7:1,8:2', formula: 'NO₂', name: 'Nitrogen Dioxide', note: 'Add one more oxygen and you get nitrogen dioxide — a toxic brown gas and major air pollutant.' },
    ],
  },
  '7:1,8:2': {
    key: '7:1,8:2',
    ...
    related: [
      { key: '7:1,8:1', formula: 'NO', name: 'Nitric Oxide', note: 'Remove one oxygen and you get nitric oxide — actually beneficial in small amounts as a signaling molecule.' },
    ],
  },
  ...
  '8:1,12:1': {
    ...
    related: [
      { key: '12:1,17:2', formula: 'MgCl₂', name: 'Magnesium Chloride', note: 'Replace oxygen with two chlorines and you get magnesium chloride — used to de-ice roads.' },
    ],
  },
  '12:1,17:2': {
    key: '12:1,17:2',
    ...
    related: [
      { key: '8:1,12:1', formula: 'MgO', name: 'Magnesium Oxide', note: 'Replace the two chlorines with one oxygen and you get magnesium oxide — the ratio changes because oxygen takes 2 electrons.' },
    ],
  },
  '11:2,8:1': {
    key: '11:2,8:1',
    ...
    related: [
      { key: '11:1,17:1', formula: 'NaCl', name: 'Table Salt', note: 'Swap oxygen for chlorine (and use one Na instead of two) to get table salt.' },
    ],
  },
  '8:1,20:1': {
    key: '8:1,20:1',
    ...
    related: [
      { key: '6:1,8:3,20:1', formula: 'CaCO₃', name: 'Calcium Carbonate', note: 'Add carbon and two more oxygens to get calcium carbonate — chalk, marble, and seashells.' },
    ],
  },
  '8:3,13:2': {
    key: '8:3,13:2',
  ...
  '8:3,26:2': {
    ...
    related: [
      { key: '8:1,26:1', formula: 'FeO', name: 'Iron(II) Oxide', note: 'Use less oxygen and you get iron(II) oxide — a black powder with different properties due to iron\'s lower charge.' },
    ],
  },
  '8:1,26:1': {
    key: '8:1,26:1',
    ...
    related: [
      { key: '8:3,26:2', formula: 'Fe₂O₃', name: 'Iron(III) Oxide', note: 'Add more oxygen and iron and you get rust (Fe₂O₃) — the more common and stable iron oxide.' },
    ],
  },
  ...
  '6:1,8:3,20:1': {
    ...
    related: [
      { key: '8:1,20:1', formula: 'CaO', name: 'Calcium Oxide', note: 'Heat calcium carbonate and it decomposes into quicklime (CaO) and CO₂ gas.' },
    ],
  },
  ...
  '1:1,8:1,11:1': {
    ...
    related: [
      { key: '11:1,17:1', formula: 'NaCl', name: 'Table Salt', note: 'NaOH + HCl → NaCl + H₂O. Neutralize lye with hydrochloric acid and you get table salt and water!' },
    ],
  },
  ...
  '17:1,20:1': {
    ...
    related: [
      { key: '17:2,20:1', formula: 'CaCl₂', name: 'Calcium Chloride', note: 'Add one more chlorine to get stable calcium chloride (CaCl₂) — the charge-balanced form.' },
    ],
  },
  ...
  '8:1,29:2': {
    ...
    related: [
      { key: '8:1,29:1', formula: 'CuO', name: 'Copper(II) Oxide', note: 'Use one copper instead of two per oxygen and copper takes a +2 charge — different ratio, different compound, different color (black vs red).' },
    ],
  },
...
/**
 * Generate a canonical lookup key from SlotEntry[].
 * Sorts by atomic number, filters zero-count entries.
 */
...
/**
 * Look up a known compound by slot entries.
 */
